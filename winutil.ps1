...
$inputXML = (new-object Net.WebClient).DownloadString("https://raw.githubusercontent.com/JorgaWetzel/TechTools/main/MainWindow.xaml?token=GHSAT0AAAAAABZLWGSCFXAJA3JB5VQUKKR2Y5LDUOA") #uncomment for Production
